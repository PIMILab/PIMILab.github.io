...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="2000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/teaser/teaser1.png" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/teaser/teaser2.png" alt="Slide 2" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/teaser/teaser3.png" alt="Slide 3" />
        </div>
    </div>
...
<figure class="fifth" style="display: flex; justify-content: center; align-items: center;">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logos/sandia.png" style="width: 300px; margin-right: 40px;">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logos/nsf.jpg" style="width: 200px; margin-right: 40px;">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logos/seacrogs.png" style="width: 300px;">
</figure>
