...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/teaser/teaser1.png" alt="Slide 1" style="display:block; margin: 0 auto; width:80%;" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/teaser/teaser2.png" alt="Slide 2" style="display:block; margin: 0 auto; width:80%;" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/teaser/teaser3.jpg" alt="Slide 3" style="display:block; margin: 0 auto; width:80%;" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/teaser/teaser4.png" alt="Slide 4" style="display:block; margin: 0 auto" />
        </div>        
    </div>
