...
![]({{ site.url }}{{ site.baseurl }}/images/teaser/teaser2.png){: style="width: 300px; float: right; margin: 30px 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/teaser/teaser3.jpg){: style="width: 300px; float: left; margin: 30px 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/teaser/teaser4.png){: style="width: 300px; float: right; margin: 30px 10px"}
