...
![]({{ site.url }}{{ site.baseurl }}/images/teaser/teaser2.png){: style="width: 250px; float: right; margin: 0px 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/teaser/teaser3.png){: style="width: 250px; float: left; margin: 0px 10px"}
