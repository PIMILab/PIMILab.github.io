...
![]({{ site.url }}{{ site.baseurl }}/images/teaser/theta_sweep_predictions.gif){: style="width: 300px; float: left; margin: 0px 10px"}
**Geometry aware learning**: Complex geometry remains a central obstacle to building general purpose learned models for science and engineering. Physical models are organized through fields, differential operators, constitutive relations, and balance laws, all defined on an underlying geometric domain. We use exterior calculus, compatible finite element methods, and meshfree discretizations to preserve this organization within neural architectures. Local constitutive behavior and reduced approximation spaces are learned from data, while geometric operators assemble these components into globally conservative models with consistent boundary treatment. This construction allows learned simulators to operate across meshes, point clouds, resolutions, and domain geometries while retaining the compatibility and stability of conventional numerical methods. These ideas provide a foundation for scientific models that can support rapid simulation, inverse problems, and engineering design over broad families of physical systems.
